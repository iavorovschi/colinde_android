...
class DefaultScrollHandle @JvmOverloads constructor(
    ...
    override fun setupLayout(pdfView: PDFView) {
        ...
        val backgroundRes: Int = when {
            ...
            isVertical -> R.drawable.carol_scroll_handle_right
            inverted -> R.drawable.default_scroll_handle_top
            else -> R.drawable.carol_scroll_handle_bottom
        }
    ...
    companion object {
        private const val DEFAULT_TEXT_SIZE: Int = 14
        private const val HANDLE_LONG: Int = 50
        private const val HANDLE_SHORT: Int = 35
    }
